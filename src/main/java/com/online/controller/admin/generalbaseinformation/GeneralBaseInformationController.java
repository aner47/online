package com.online.controller.admin.generalbaseinformation;
...
@Controller("adminGeneralBaseInformationController")
@RequestMapping("/admin/generalbaseinformation")
public class GeneralBaseInformationController extends BaseController {
	...
	public String list(ModelMap model) {
		...
		FieldModule fieldModule = fieldModuleService.findByNameTableType(Constants.FIELD_general_baseinformation);
		if(fieldModule != null ){
		...
		return "/admin/generalbaseinformation/list";
	}
