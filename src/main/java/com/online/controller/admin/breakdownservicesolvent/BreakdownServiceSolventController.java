package com.online.controller.admin.breakdownservicesolvent;
...
@Controller("adminbreakdownServiceSolventController")
@RequestMapping("/admin/breakdownservicesolvent")
