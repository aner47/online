package com.online.controller.admin.boilerinformation;
...
@Controller("boilerInformationController")
@RequestMapping("/admin/boilerinformation")
public class BoilerInformationController extends BaseController{
	...
	public Page<BoilerInformation> query(Pageable pageable,BoilerInformation boilerInformation) {
		...
		pageable.addEntity(boilerInformation);
