package com.online.controller.admin.exhaustionhole;
...
@Controller("exhaustionHoleController")
@RequestMapping("/admin/exhaustionhole")
public class ExhaustionHoleController extends BaseController{
	...
	public Page<ExhaustionHole> query(Pageable pageable,ExhaustionHole exhaustionHole) {
		...
		//pageable.addFilter("project", Operator.eq,SpringUtils.getCurrentProject()).addFilter("enterprise", Operator.eq, SpringUtils.getCurrentEnterprise());
	...
	public Message save(ExhaustionHole  exhaustionHole) {
		 exhaustionHoleService.save(exhaustionHole);
