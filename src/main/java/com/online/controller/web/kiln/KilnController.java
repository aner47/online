package com.online.controller.web.kiln;
...
@Controller("webKilnController")
@RequestMapping("/web/kiln")
public class KilnController extends BaseController{
	...
	public @ResponseBody Message delete(Integer... ids) {
		for (int i = 0; i < ids.length; i++) {
			...
			monthlyInformationService.deleteByType(Constants.MONTH_TYPE_KILN,ids[i]);
		}
		return Message.success();
	}
	/**
