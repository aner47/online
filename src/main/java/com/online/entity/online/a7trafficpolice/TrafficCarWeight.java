...
@Entity
@Table(name="ol_traffic_car_weight")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "seq_ol_traffic_car_weight")
public class TrafficCarWeight extends BaseEntity<Integer> {
