 ...
 * 市海事局-客货运输船舶每月活动水平信息
 */
@EntityDescription(caption="客货运输船舶每月活动水平信息")
@Entity
@Table(name="ol_transport_ship_month")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "seq_ol_transport_ship_month")
public class TransportShipMonth extends BaseEntity<Integer> {
