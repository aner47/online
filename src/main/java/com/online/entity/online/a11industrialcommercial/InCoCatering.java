 ...
 * 市工商局-餐饮企业工商登记信息表
 */
@EntityDescription(caption="餐饮企业工商登记信息表")
@Entity
@Table(name="ol_in_co_catering")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "seq_ol_in_co_catering")
public class InCoCatering extends BaseEntity<Integer> {
	 ...
	 * 经营范围
	 */
	@ColumnDescription(caption="05_经营范围")
