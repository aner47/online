...
public class AutomaticRating {
	...
	public static void main(String[] args) {
		...
		String strA = "中科弘清发电公司方会计师的开发了坚实的看了附件是的开发积分福建省的咖啡机路上看非金属打飞机的发";

		String strB = "弘清中公科北京司中科弘清发电公司方会计师的开发了坚实的看了附件是的开发积分福建省的咖啡机路上看非金属打飞机的发";
