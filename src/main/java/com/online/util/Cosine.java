...
public class Cosine {
	public static double getSimilarity(String doc1, String doc2) {
		if (doc1 != null && doc1.trim().length() > 0 && doc2 != null && doc2.trim().length() > 0) {
			...
			throw new NullPointerException("theDocumentisnullorhavenotcahrs!!");
		}
	}
	...
	public static boolean isHanZi(char ch) {
		...
		/*
		 * if(ch>=0x4E00&&ch<=0x9FA5){//汉字 returntrue; }else{ Stringstr=""+ch;
		 * booleanisNum=str.matches("[0-9]+"); returnisNum; }
		 */
		/*
		 * if(Character.isLetterOrDigit(ch)){ Stringstr=""+ch;
		 * if(str.matches("[0-9a-zA-Z\\u4e00-\\u9fa5]+")){//非乱码 returntrue;
		 * }elsereturnfalse; }elsereturnfalse;
		 */
	}
	 ...
	 *
	 * @paramch输入的GB2312中文字符或者ASCII字符(128个)
	 * 
