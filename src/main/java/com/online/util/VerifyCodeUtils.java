...
public class VerifyCodeUtils{
    ...
    public static void generalPic(String key,OutputStream out) throws IOException{
    ...
    public static boolean valid(String key,String code){
    	if(map.get(key).equalsIgnoreCase(code)){
    		map.remove(key);
    		return true;
    	}else{
    		return false;
