						...
						.validate(
								{
									...
									messages : {
										...
										password : {
											rangelength : '6-14位字符 中英文均可，不予许有空格！',
										},
									},
												...
												.ajax({
													...
													data : {
														...
														"industry_category_code" : $(
																'input[name=industry_category_code]')
																.val(),
														"industry_category_code_middle" : $(
																'input[name=industry_category_code_middle]')
																.val(),
														"industry_category_name_middle" : $(
																'input[name=industry_category_name_middle]')
																.val(),
														"industry_category_name" : $(
																'input[name=industry_category_name]')
																.val(),
														"code" : $(
																'input[name=code]')
																.val(),
						...
						<form id="formchecktwo" method="get" action="">
							...
							<div class="reg_linediv">
								<div class="reg_lineleft">
									...
									<div class="reg_inputdiv">
										<input type="text" name="contact_number" class="reg_inputwd"
											placeholder="" />
											</div>
									</div>
								</div>
