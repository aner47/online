	...
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				columns :[
					...
					{name:"roadType",caption:"道路类型",hidden:false,type:"text"},
					{name:"roadDate",caption:"日期",hidden:false,type:"text"},
					{name:"startTime",caption:"开始时间",hidden:false,type:"text"},
					{name:"endTime",caption:"结束时间",hidden:false,type:"text"},
					{name:"flowLargeCar",caption:"大型车车流量（辆/小时）",hidden:false,type:"text"},
					{name:"flowSmallCar",caption:"小型车车流量（辆/小时）",hidden:false,type:"text"},
					{name:"flowBus",caption:"公交车车流量（辆/小时）",hidden:false,type:"text"},
					{name:"flowMotorbike",caption:"摩托车车流量（辆/小时）",hidden:false,type:"text"},
