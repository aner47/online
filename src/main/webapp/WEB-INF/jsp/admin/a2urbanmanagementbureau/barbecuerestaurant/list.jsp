...
<script type="text/javascript">
	require(["grid","hide","upload","select","panel"],function(g,hide,upload){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"enterprise.name",caption:"烧烤店名称",hidden:false,type:"text"},
					...
					{name:"contactNumber",caption:"联系电话",hidden:false,type:"text"},
					{name:"isOpenBarbecue",caption:"是否露天烧烤",hidden:false,type:"text"},
					{name:"annualBusinessDays",caption:"每年经营天数（天）",hidden:false,type:"text"},
					{name:"manageHour",caption:"每日经营时间（时）",hidden:false,type:"text"},
					...
					{name:"operate",caption:"操作",width:120,isHtml:true,html:'<a id="view" style="cursor: pointer;color:#888888;"><i id="tianbao" class="iconfont icon-bianji" style="color:#6495ED;">上传图片</i></a>',	
						events :[{
								...
								handle:function(){
									...
									location.href="../photofile/departmentlist.jhtml?enterpriseId="+id+"&departmentType=CGJShaoKaoDian";
		...
		$("#download").click(function(){
			location.href="../barbecuerestaurant/downloanExcel.jhtml"
		});
