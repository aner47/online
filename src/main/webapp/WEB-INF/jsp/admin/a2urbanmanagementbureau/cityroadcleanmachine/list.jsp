...
<script type="text/javascript">
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"city",caption:"区县",hidden:false,type:"text"},
					{name:"roadName",caption:"道路名称",hidden:false,type:"text"},
					{name:"roadGrade",caption:"道路级别（主/次/支）",hidden:false,type:"text"},
					{name:"enthesis",caption:"起止点",hidden:false,type:"text"},
					{name:"length",caption:"长度（m）",hidden:false,type:"text"},
					{name:"fastRoadWidth",caption:"快车道宽度（m）",hidden:false,type:"text"},
					{name:"sidewalkWidth",caption:"人行道宽度（m）",hidden:false,type:"text"},
					{name:"fastRoadArea",caption:"快车道道路面积（㎡）",hidden:false,type:"text"},
					{name:"sidewalkArea",caption:"人行道道路面积（㎡）",hidden:false,type:"text"},
					{name:"areaTotal",caption:"道路面积合计",hidden:false,type:"text"},
					{name:"cleaningSweeperTruck",caption:"洗扫车（台）",hidden:false,type:"text"},
					{name:"vacuumSweeper",caption:"吸尘车（台）",hidden:false,type:"text"},
					{name:"mistCannonTruck",caption:"雾炮车（台）",hidden:false,type:"text"},
					{name:"otherTruck",caption:"其他车辆（台）",hidden:false,type:"text"},
