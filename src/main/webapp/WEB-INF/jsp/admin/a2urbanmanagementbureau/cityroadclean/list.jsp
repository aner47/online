	...
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				columns :[
					...
					{name:"roadNum",caption:"道路数量（条）",hidden:false,type:"text"},
					{name:"roadlength",caption:"道路累计长度（千米）",hidden:false,type:"text"},
					{name:"cleanArea",caption:"清扫面积（平方米）",hidden:false,type:"text"},
					{name:"cleanFrequency",caption:"每天清扫频次（次）",hidden:false,type:"text"},
					{name:"machineCleanRate",caption:"机扫率（%）",hidden:false,type:"text"},
					{name:"cleanMethod",caption:"清扫方式（干法/湿法）",hidden:false,type:"text"},
					{name:"wateringFrequency",caption:"每天洒水频次（次）",hidden:false,type:"text"},
