	...
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				columns :[
					...
					{name:"january",caption:"一月（辆）",width:60/5,hidden:false,type:"text"},
					{name:"february",caption:"二月（辆）",width:60/5,hidden:false,type:"text"},
					{name:"march",caption:"三月（辆）",width:60/5,hidden:false,type:"text"},
					{name:"april",caption:"四月（辆）",width:60/5,hidden:false,type:"text"},
					{name:"may",caption:"五月（辆）",width:60/5,hidden:false,type:"text"},
					{name:"june",caption:"六月（辆）",width:60/5,hidden:false,type:"text"},
					{name:"july",caption:"七月（辆）",width:60/5,hidden:false,type:"text"},
					{name:"august",caption:"八月（辆）",width:60/5,hidden:false,type:"text"},
					{name:"september",caption:"九月（辆）",width:60/5,hidden:false,type:"text"},
					{name:"october",caption:"十月（辆）",width:60/5,hidden:false,type:"text"},
					{name:"november",caption:"十一月（辆）",width:60/5,hidden:false,type:"text"},
					{name:"december",caption:"十二月（辆）",width:60/5,hidden:false,type:"text"},
