...
require(["grid","select","panel","multselect","less"],function(g){
		$('#delete').click(function(e){//删除
			qy.del({
				title:'是否删除所选'+grid1.getSelectedValue('id').length+'条部门信息?',
				yes:function(index){
					layer.close(index);
		...
		var opts = {
				...
				url:"query.jhtml",
				columns :[
				    {name:"name",caption:"部门名称",hidden:false,type:"text"},
				    {name:"pid",caption:"上级部门",hidden:false,type:"text"},
		...
		<h1 class="title">
            ...
            <form id="queryForm" action="">
                <div class="group col-lg-5f1 col-md-3 unmust">
                    <label class="form-label" for="name">部门名称</label> <input
