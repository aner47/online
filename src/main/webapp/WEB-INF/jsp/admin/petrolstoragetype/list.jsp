...
<script type="text/javascript">
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"id",caption:"储罐编号",width:60/5,hidden:false,type:"text"},
					{name:"storageTinType",caption:"储罐类型",width:60/5,hidden:false,type:"text"},
					{name:"storageMatterName",caption:"存储物质名称",width:60/5,hidden:false,type:"text"},
					{name:"avgWorkCubage",caption:"平均工作容量（立方米）",width:60/5,hidden:false,type:"text"},
					{name:"annualUseDays",caption:"年使用天数",width:60/5,hidden:false,type:"text"},
					{name:"annualPadNumber",caption:"年填充次数",width:60/5,hidden:false,type:"text"},
					{name:"annualStorageSum",caption:"年总存储量",width:60/5,hidden:false,type:"text"},
					{name:"annualStorageSumUnit",caption:"单位",width:60/5,hidden:false,type:"text"},
					{name:"colour",caption:"颜色",width:60/5,hidden:false,type:"text"},
					{name:"shell",caption:"外壳",width:60/5,hidden:false,type:"text"},
		...
		$('#delete').click(function(e){//删除
			if($(this).attr("disabled")) return;
			qy.sure({
				title:'是否删除所选'+grid1.getSelectedValue('id').length+'条机储罐类型信息?',
				yes:function(index){
					layer.close(index);
