...
require(["hide","validate","ajaxform","select","panel","year"],function(hide){
	var year = $('#monthinfo_form #year').year({'name':'year',defaultValue:'${monthlyInformation.year}'})
	...
	//生产线	
	 ...
	 var name = $('#monthinfo_form #name').select({name:'name',zIndex:20
		 	,defaultValue:'${monthlyInformation.name}'
			...
			,change:function(enevt,value){
		 	...
		 	,initAfter:function(data,value,otherValue){
		 		console.log(value);
				console.log(otherValue);
				sourceConsumption = otherValue.consumption;
				sourceUnit = otherValue.unit;
				if(sourceConsumption != -1){
					$('#monthinfo_form #consumption').val(sourceConsumption);
				}else{
					$('#monthinfo_form #consumption').val('');
				}
				$('#monthinfo_form #monthType').val(otherValue.type);
		 	}
			});
	var unit = $('#monthinfo_form #unit').select({name:'unit',isCustom: true,defaultValue:'${monthlyInformation.unit}',zIndex:19});	
...
<body>
	...
	<form id="monthinfo_form" style="padding:0;width:100%;">
		...
		<input type="hidden" name="id" value="${monthlyInformation.id }" />
		<input type="hidden" class="input" id="powerPlantId" name="powerPlantId" value="${monthlyInformation.powerPlantId }"/>
		<input type="hidden" class="input" id="boilerId" name="boilerId" value="${monthlyInformation.boilerId }"/>
		<input type="hidden" class="input" id="gasstoveId" name="gasstoveId" value="${monthlyInformation.gasstoveId }"/>
			<input type="hidden" class="input" id="kilnId" name="kilnId" value="${monthlyInformation.kilnId }"/>
			<input type="hidden" class="input" id="sectionId" name="sectionId" value="${monthlyInformation.sectionId }"/>
			<input type="hidden" class="input" id="rawMaterialsId" name="rawMaterialsId" value="${monthlyInformation.rawMaterialsId }"/>
		<input type="hidden" class="input" id="monthType" name="monthType" value="${monthlyInformation.monthType }"/>
		<div class="infLine">
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<%-- <input type="" class="input" name="unit" value="${monthlyInformation.unit }"> --%>
			...
			<div class="infPara infPara3">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="january" value="${monthlyInformation.january }" number="true" required>
					</div>
				</div>
			</div>
			...
			<div class="infPara infPara3">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="february" value="${monthlyInformation.february }" number="true" required>
					</div>
				</div>
			</div>
			...
			<div class="infPara infPara3">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="march" value="${monthlyInformation.march }" number="true" required>
					</div>
				</div>
			</div>
			...
			<div class="infPara infPara3">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="april" value="${monthlyInformation.april }" number="true" required>
					</div>
				</div>
			</div>
			...
			<div class="infPara infPara3">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="may" value="${monthlyInformation.may }" number="true" required>
					</div>
				</div>
			</div>
			...
			<div class="infPara infPara3">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="june" value="${monthlyInformation.june }" number="true" required>
					</div>
				</div>
			</div>
			...
			<div class="infPara infPara3">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="july" value="${monthlyInformation.july }" number="true" required>
					</div>
				</div>
			</div>
			...
			<div class="infPara infPara3">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="august" value="${monthlyInformation.august }" number="true" required>
					</div>
				</div>
			</div>
			...
			<div class="infPara infPara3">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="september" value="${monthlyInformation.september }" number="true" required>
					</div>
				</div>
			</div>
			...
			<div class="infPara infPara3">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="october" value="${monthlyInformation.october }" number="true" required>
					</div>
				</div>
			</div>
			...
			<div class="infPara infPara3">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="november" value="${monthlyInformation.november }" number="true" required>
					</div>
				</div>
			</div>
			...
			<div class="infPara infPara3">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="december" value="${monthlyInformation.december }" number="true" required>
					</div>
				</div>
			</div>
			...
			<div class="infPara infPara2">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<textarea class="textarea" name="description">${monthlyInformation.description }</textarea>
					</div>
				</div>
			</div>
