	...
	<form id="inputForm">
		<div class="container">
	        ...
	        <div class="form-line">
	            ...
	            <input type="text" id="alreadyEnterpriseId" name="alreadyEnterpriseId" 
	             value="${enterpriseDictionary.alreadyEnterpriseId}"
	            />
	        </div>
	        <div class="form-line">
	            <label for="enterpriseName" >标记项：</label>
	            <input type="text" id="sign" name="sign" value="${enterpriseDictionary.sign}"/>
	        </div>
			<div class="form-line">
			...
			<div class="form-line">
				<label for="inputIndustry">行业：</label> <input type="text"
					id="inputIndustry" name="inputIndustry" placeholder="行业"
					value="${enterpriseDictionary.inputIndustry}" />
			</div>
			<div class="form-line">
			...
			<div class="form-line">
	            ...
	            value="${enterpriseDictionary.contactsPhone}" />
	        </div>
			<div class="form-line">
