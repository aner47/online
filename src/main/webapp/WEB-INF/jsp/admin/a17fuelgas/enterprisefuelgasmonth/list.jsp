...
<script type="text/javascript">
	require(["grid","hide","upload","select","panel"],function(g,hide,upload){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"enterprise.name",caption:"工业企业名称",hidden:false,type:"text"},
					{name:"january",caption:"一月（万立方米）",hidden:false,type:"text"},
				    {name:"february",caption:"二月（万立方米）",hidden:false,type:"text"},
				    {name:"march",caption:"三月（万立方米）",hidden:false,type:"text"},
				    {name:"april",caption:"四月（万立方米）",hidden:false,type:"text"},
				    {name:"may",caption:"五月（万立方米）",hidden:false,type:"text"},
				    {name:"june",caption:"六月（万立方米）",hidden:false,type:"text"},
				    {name:"july",caption:"七月（万立方米）",hidden:false,type:"text"},
				    {name:"august",caption:"八月（万立方米）",hidden:false,type:"text"},
				    {name:"september",caption:"九月（万立方米）",hidden:false,type:"text"},
				    {name:"october",caption:"十月（万立方米）",hidden:false,type:"text"},
				    {name:"november",caption:"十一月（万立方米）",hidden:false,type:"text"},
				    {name:"december",caption:"十二月（万立方米）",hidden:false,type:"text"},
				    ...
				    {name:"operate",caption:"操作",width:120,isHtml:true,html:'<a id="view" style="cursor: pointer;color:#888888;"><i id="tianbao" class="iconfont icon-bianji" style="color:#6495ED;">上传图片</i></a>',	
						events :[{
								...
								handle:function(){
									...
									location.href="../photofile/departmentlist.jhtml?enterpriseId="+id+"&departmentType=RQGSGongYeXiaoHaoMeiYue";
		...
		$("#download").click(function(){
			location.href="../enterprisefuelgasmonth/downloanExcel.jhtml"
		});
