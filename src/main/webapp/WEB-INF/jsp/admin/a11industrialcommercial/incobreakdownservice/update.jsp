			...
			function(hide) {
				...
				$("#boiler_form").validate({
					...
					submitHandler : function(form) {
						...
						var options = {
							url : '../incobreakdownservice/update.jhtml',
							type : 'post',
							dataType : 'json',
		...
		<div class="container">
			...
			<div class="infPara ">
				<div class="infParaCon">
					<label for="" class="infpLable">汽修企业名称</label>
					<div class="infpCon">
						<input type="" class="input" id="汽修企业名称" name="enterprise.name"
							value="${inCoBreakdownService.enterprise.name}" required>
					</div>
				</div>
			</div>
			<div class="infPara ">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" id="contacts" name="contacts"
							value="${inCoBreakdownService.contacts}">
					</div>
				</div>
			</div>
			<div class="infPara ">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" id="contactNumber"
							name="contactNumber"
							value="${inCoBreakdownService.contactNumber}">
					</div>
				</div>
			</div>
			<div class="infPara ">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" id="city" name="city"
							value="${inCoBreakdownService.city}">
					</div>
				</div>
			</div>
			<div class="infPara ">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" id="houseNumber" name="houseNumber"
							value="${inCoBreakdownService.houseNumber}">
					</div>
				</div>
			</div>
			<div class="infPara ">
				<div class="infParaCon">
					<label for="" class="infpLable">油漆使用量/吨</label>
					<div class="infpCon">
						<input type="" class="input" id="usePaintQuantity"
							name="usePaintQuantity"
							value="${inCoBreakdownService.usePaintQuantity}"
							number="true" onKeyUp="value=value.replace(/[^0-9.]/g,'')">
					</div>
				</div>
			</div>
			<input type="hidden" id="id" name="id"
				value="${inCoBreakdownService.id}" />

			<div class="infPara infPara2">
				<div class="infParaCon">
					<label for="" class="infpLable">备注</label>
					<div class="infpCon">
						<textarea class="textarea" name="description">${inCoBreakdownService.description}</textarea>
					</div>
				</div>
			</div>
