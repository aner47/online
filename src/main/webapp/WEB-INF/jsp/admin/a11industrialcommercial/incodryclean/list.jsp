...
<script type="text/javascript">
	require(["grid","hide","upload","select","panel"],function(g,hide,upload){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
				    {name:"enterprise.name",caption:"干洗企业名称",hidden:false,type:"text"},
				    ...
				    {name:"detergent",caption:"干洗剂用量/吨",hidden:false,type:"text"},
				    ...
				    {name:"operate",caption:"操作",width:120,isHtml:true,html:'<a id="view" style="cursor: pointer;color:#888888;"><i id="tianbao" class="iconfont icon-bianji" style="color:#6495ED;">上传图片</i></a>',	
						events :[{
								...
								handle:function(){
									...
									location.href="../photofile/departmentlist.jhtml?enterpriseId="+id+"&departmentType=GSJGanxi";
		...
		$("#download").click(function(){
			location.href="../incodryclean/downloanExcel.jhtml"
		});
