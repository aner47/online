...
require(["grid","select","panel","less"],function(g){
		$('#delete').click(function(e){//删除
			layer.confirm('是否删除所选'+grid1.getSelectedValue('id').length+'条原辅料标准名称配置信息?', {icon: 2, title:'系统提示信息',cancel:function(index){layer.close(index);}}, function(index){
	    		layer.close(index);
				...
				var opts ={
					...
					callBack:function(data,errcode){
						if(errcode!=="000000"){
							layer.msg('删除原辅料标准名称配置成功！', {icon: 6});
							grid1.loadData();
						}else{
							layer.msg('删除原辅料标准名称配置失败！', {icon: 5});
						}
					}
				}
				qy.ajax(opts);
		...
		var opts = {
				...
				columns :[
                    ...
                    {name:"standardName",caption:"原辅料名称",hidden:false,type:"text"},
...
<body>
    <div class="block ">
        ...
        <form id="queryForm" action="">
            ...
            <label class="form-label" for="standardName">辅料名称</label>
