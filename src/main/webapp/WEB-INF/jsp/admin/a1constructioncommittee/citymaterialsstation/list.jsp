	...
	require(["grid","hide","upload","select","panel"],function(g,hide,upload){
		var opts = {
				...
				columns :[
					...
					{name:"enterprise.name",caption:"材料站名称",hidden:false,type:"text"},
					...
					{name:"capacity",caption:"产能（立方米/月）",hidden:false,type:"text"},
					{name:"floorSpace",caption:"占地面积（亩）",hidden:false,type:"text"},
					{name:"stockgroundDustMeasures",caption:"料场抑尘措施",hidden:false,type:"text",valueSet:"混凝土搅拌站信息【料场抑尘措施】"},
					{name:"feedinletDustMeasures",caption:"上料口抑尘措施",hidden:false,type:"text",valueSet:"混凝土搅拌站信息【上料口抑尘措施】"},
					{name:"isBagTypeDuster",caption:"粉料筒仓上部是否配套高效布袋除尘器",hidden:false,type:"text"},
					...
					{name:"operate",caption:"操作",width:120,isHtml:true,html:'<a id="view" style="cursor: pointer;color:#888888;"><i id="tianbao" class="iconfont icon-bianji" style="color:#6495ED;">上传图片</i></a>',	
						events :[{
								...
								handle:function(){
									...
									location.href="../photofile/departmentlist.jhtml?enterpriseId="+id+"&departmentType=ZJWCaiLiaoZhan";
		...
		$("#download").click(function(){
			location.href="../citymaterialsstation/downloanExcel.jhtml"
		});
