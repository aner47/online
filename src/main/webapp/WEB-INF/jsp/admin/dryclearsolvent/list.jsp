...
<script type="text/javascript">
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"solventType",caption:"有机溶剂类型",width:60/5,hidden:false,type:"text"},
					{name:"usageAmount",caption:"年使用量",width:60/5,hidden:false,type:"text"},
		...
		$('#delete').click(function(e){//删除
			if($(this).attr("disabled")) return;
			qy.sure({
				title:'是否删除所选'+grid1.getSelectedValue('id').length+'条机有机溶剂使用量?',
				yes:function(index){
					layer.close(index);
