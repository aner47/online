...
<body onkeypress=KeyDown(event)>
	...
	<h1 class="title">地区统计</h1>
	  	
	 <div id="area" class="areaj"></div>
	  <div id="time" hidden="true"></div>
	 <div class="clearfix"></div>
	 <div id="user" style="padding-top:100px;" hidden="true"></div>
	 <div id="inquirer" style="padding-top:100px;" hidden="true"></div>
	 <div class="clearfix"></div>
	 <div id="enterpriseType" style="padding-top:100px;" hidden="true"></div>
	 <div class="clearfix"></div>
	 <div id="normalMain" style="padding-top:100px;" hidden="true"></div>
	 <div id="normalMiddle" style="padding-top:100px;" hidden="true"></div>
	 <div class="clearfix" hidden="true"></div>
	 <div id="simpleMain" style="padding-top:100px;" hidden="true"></div>
	 <div id="simpleMiddle" style="padding-top:100px;" hidden="true"></div>
</body>
</html>