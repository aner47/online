...
<script type="text/javascript">
	require(["grid","hide","upload","select","panel"],function(g,hide,upload){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"palce",caption:"所在地",hidden:false,type:"text"},
				    {name:"city",caption:"行政区域",hidden:false,type:"text"},
				    {name:"enterprise.name",caption:"企业名称",hidden:false,type:"text"},
				    ...
				    {name:"steamTon",caption:"蒸吨数",hidden:false,type:"text"},
				    {name:"lastExamineDate",caption:"上次检测日期",hidden:false,type:"text"},
				    {name:"nextExamineDate",caption:"下次检测日期",hidden:false,type:"text"},
				    ...
				    {name:"operate",caption:"操作",width:120,isHtml:true,html:'<a id="view" style="cursor: pointer;color:#888888;"><i id="tianbao" class="iconfont icon-bianji" style="color:#6495ED;">上传图片</i></a>',	
						events :[{
								...
								handle:function(){
									...
									location.href="../photofile/departmentlist.jhtml?enterpriseId="+id+"&departmentType=ZJJGuoLu";
		...
		$("#download").click(function(){
			location.href="../boilerqs/downloanExcel.jhtml"
		});
