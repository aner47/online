...
<script type="text/javascript">
	require(["grid","hide","select","panel"],function(g,hide){
		...
		var opts = {
				...
				columns :[
					{name:"sectionId",caption:"对应工段/工艺名称",hidden:false,type:"text",valueSet:"简单表单【工段】"},
				    ...
				    {name:"unit",caption:"数量单位",hidden:false,type:"text"},
