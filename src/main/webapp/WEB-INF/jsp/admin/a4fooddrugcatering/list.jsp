	...
	require(["grid","hide","upload","select","panel"],function(g,hide,upload){
		var opts = {
				...
				columns :[
					...
					{name:"enterprise.name",caption:"餐企名称",hidden:false,type:"text"},
					{name:"longitude",caption:"经度",hidden:false,type:"text"},
					{name:"latitude",caption:"纬度",hidden:false,type:"text"},
					{name:"area",caption:"经营场所面积（平方米）",hidden:false,type:"text"},
					{name:"cookingRange",caption:"固定灶头数（个）",hidden:false,type:"text"},
					{name:"fuelType",caption:"燃料类型",hidden:false,type:"text"},
					{name:"fuelConsumption",caption:"年燃料消耗量（吨/立方米/度）",hidden:false,type:"text"},
					{name:"exhaustAir",caption:"单个灶头平均排风量（立方米/小时）",hidden:false,type:"text"},
					...
					{name:"operate",caption:"操作",width:120,isHtml:true,html:'<a id="view" style="cursor: pointer;color:#888888;"><i id="tianbao" class="iconfont icon-bianji" style="color:#6495ED;">上传图片</i></a>',	
						events :[{
								...
								handle:function(){
									...
									location.href="../photofile/departmentlist.jhtml?enterpriseId="+id+"&departmentType=SYJJCanYin";
		...
		$("#download").click(function(){
			location.href="../fooddrugcatering/downloanExcel.jhtml"
		});
