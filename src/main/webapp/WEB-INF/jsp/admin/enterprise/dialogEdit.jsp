...
$("#inputForm").validate({
	...
	var enterpriseType = $("#enterpriseType","#inputForm").select({name:"enterpriseType",immutable:false,defaultValue:'${enterprise.enterpriseType}',zIndex:14,change:function(event, value){
   		projectType.loadData("project:"+'${project.id}'+",enterpriseType:"+value);
	     
	}});
   	var projectType = $("#projectType","#inputForm").select({name:"projectType",param:"project:"+'${project.id}'+",enterpriseType:"+'${enterprise.enterpriseType}',defaultValue:'${projectType}',zIndex:13});
