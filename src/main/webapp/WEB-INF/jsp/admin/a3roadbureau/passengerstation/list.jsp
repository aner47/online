...
<script type="text/javascript">
	require(["grid","hide","upload","select","panel"],function(g,hide,upload){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"city",caption:"行政区划",hidden:false,type:"text"},
					{name:"enterprise.name",caption:"公司名称",hidden:false,type:"text"},
					{name:"houseNumber",caption:"地址",hidden:false,type:"text"},
					{name:"area",caption:"占地面积",hidden:false,type:"text"},
					{name:"longitude",caption:"经度",hidden:false,type:"text"},
					{name:"latitude",caption:"纬度",hidden:false,type:"text"},
					{name:"yearInout",caption:"全年进/出车辆次数",hidden:false,type:"text"},
					{name:"dayInout",caption:"每天进/出车辆次数",hidden:false,type:"text"},
					{name:"carType",caption:"车辆类型",hidden:false,type:"text"},
					{name:"oilType",caption:"燃油类型",hidden:false,type:"text"},
					{name:"stayTime",caption:"车辆平均停留时间",hidden:false,type:"text"},
					...
					{name:"operate",caption:"操作",width:120,isHtml:true,html:'<a id="view" style="cursor: pointer;color:#888888;"><i id="tianbao" class="iconfont icon-bianji" style="color:#6495ED;">上传图片</i></a>',	
						events :[{
								...
								handle:function(){
									...
									location.href="../photofile/departmentlist.jhtml?enterpriseId="+id+"&departmentType=JTJKeYunZhan";
		...
		$("#download").click(function(){
			location.href="../passengerstation/downloanExcel.jhtml"
		});
