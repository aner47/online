...
require(["hide","validate","ajaxform","select","panel"],function(hide){
	$("#tankMaterialType","#oiltank_form").select({name:"tankMaterialType",defaultValue:'${oilTank.tankMaterialType}'});
	$("#tankType","#oiltank_form").select({name:"tankType",defaultValue:'${oilTank.tankType}'});
		...
		$("#oiltank_form").validate({
			...
			submitHandler:function(form){
				var options  = {
			        url:base+"/web/oiltank/update.jhtml",
			        type:'post',
			        dataType : 'json',
		...
		<div class="infLine">
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="num" value="${oilTank.num}" number=true>
					</div>
				</div>
			</div>
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="storageCapacity" value="${oilTank.storageCapacity}" number=true>
					</div>
				</div>
			</div>
