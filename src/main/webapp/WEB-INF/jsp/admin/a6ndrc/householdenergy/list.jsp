	...
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				columns :[
					...
					{name:"residentsNumber",caption:"居民户数",hidden:false,type:"text"},
					{name:"scatteredCoalNumber",caption:"累计散煤户数",hidden:false,type:"text"},
					{name:"scatteredCoaluse",caption:"累计年散煤用量（吨）",hidden:false,type:"text"},
					{name:"naturalGasNum",caption:"累计天然气户数",hidden:false,type:"text"},
					{name:"naturalGasUse",caption:"累计天然气用量（万立方米）",hidden:false,type:"text"},
					{name:"liquefiedGasNum",caption:"累计液化石油气户数",hidden:false,type:"text"},
					{name:"liquefiedGasUse",caption:"累计液化石油气用量（万立方米）",hidden:false,type:"text"},
