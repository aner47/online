...
require(["grid","select","panel","less"],function(g){
	$("#queryForm #moduleClassification").select({filter:true,name:"moduleClassification",zIndex:3,change:function(event, value){}});
		...
		var opts = {
				...
				url:"query.jhtml",
				columns :[
								    {name:"name",caption:"模块名称",hidden:false,type:"text",sort:true},
								    {name:"moduleType",caption:"模块类型",hidden:false,type:"text"},
								    {name:"order",caption:"模块排序",hidden:false,type:"text",sort:true},
							/* 	    {name:"status",caption:"状态",hidden:false,type:"text",sort:true}, */
								    {name:"moduleClassification",caption:"填表类型",hidden:false,type:"text",valueSet:"企业【企业类型】"}, 
								    {name:"type",caption:"模块类型",hidden:false,type:"text",valueSet:"字段模块【类型】"}, 
								    ...
								    {name:"operate",caption:"操作",isHtml:true,html:'<a id="view"  style="cursor: pointer;"><i class="iconfont icon-xiangqing"></i></a>',
			                             events :[{
			                                      ...
			                                      handle:function(){
			                                            ...
			                                            location.href = "../moduledetail/list.jhtml?moduleId="+id;
			                                      }
			                                    }]
			                      }	
					]
		...
		<div class="form-line form-line2">
			<form id="queryForm" action="">
				...
				<div class="group col-lg-5f1 col-md-3 unmust">
					...
					<div id="moduleClassification" class="selectF" data-code="企业【企业类型】" ></div>
				</div>
