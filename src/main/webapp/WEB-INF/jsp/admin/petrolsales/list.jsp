...
<script type="text/javascript">
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"productName",caption:"产品名称",width:80/5,hidden:false,type:"text"},
		...
		$('#delete').click(function(e){//删除
			if($(this).attr("disabled")) return;
			qy.sure({
				title:'是否删除所选'+grid1.getSelectedValue('id').length+'条机分月经销信息?',
				yes:function(index){
					layer.close(index);
...
<body>
	<div class="block">
		<h1 class="title">
			<i class="iconfont icon-fenyueshuju"></i>
			分月经销信息
