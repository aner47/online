...
<script type="text/javascript">
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"materialName",caption:"运输物料名称",width:60/5,hidden:false,type:"text",prefix:"P"},
					...
					{name:"year",caption:"年份",width:60/5,hidden:false,type:"text"},
					...
					{name:"avgLoad",caption:"平均载重（吨）",width:60/5,hidden:false,type:"text"},
