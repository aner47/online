...
require(["hide","validate","ajaxform","select","panel"],function(hide){
		...
		var materialType = $("#materialType","#openyard_form").select({name:"materialType",zIndex:4,isCustom : true});
		var measure1 = $("#measure1","#openyard_form").select({name:"measure1",zIndex:3,isCustom : true});
		var measure2 = $("#measure2","#openyard_form").select({name:"measure2",zIndex:2,isCustom : true});
		var measure3 = $("#measure3","#openyard_form").select({name:"measure3",zIndex:1,isCustom : true});
		...
		<div class="infLine">
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="area" number=true required/>
					</div>
				</div>
			</div>
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="loadAmount" number=true required>
					</div>
				</div>
			</div>
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div id="broken_environment" class="infpCon errorType1">
