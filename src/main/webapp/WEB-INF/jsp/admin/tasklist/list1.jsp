...
require(["grid","select","panel","less"],function(g){
		...
		var opts = {
				...
				columns :[
				    ...
				    {name:"operate",caption:"编辑",isHtml:true,html:'<a id="view"  style="cursor: pointer;"><i class="">编辑</i></a>',
                    	events :[{
                               type:'click',
                               select:'#view',
                               handle:function(){
                            	   ...
                            	   var id= grid1.getCurrentRowValue(this,'id');
           							//if(currentUser == '每日任务处理员'){
           								var opts = {
         		                             title: "修改任务内容信息",
         		                             url : "../tasklist/updatePage.jhtml",
         		                             data:{id:id},
         		                             yes : function(){
         		                                 $("#inputForm").submit();
         		                             },
