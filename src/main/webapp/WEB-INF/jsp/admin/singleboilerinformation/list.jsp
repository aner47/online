...
<script type="text/javascript">
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"id",caption:"锅炉编号",width:60/5,hidden:false,type:"text",prefix:"P"},
					{name:"boilerType",caption:"锅炉类型",width:60/5,hidden:false,type:"text"},
					{name:"boilerModel",caption:"锅炉型号",width:60/5,hidden:false,type:"text"},
					...
					{name:"governanceMeasures1",caption:"脱硫工艺",width:60/5,hidden:false,type:"text"},
					{name:"governanceMeasures2",caption:"脱硝工艺",width:60/5,hidden:false,type:"text"},
					{name:"governanceMeasures3",caption:"除尘工艺",width:60/5,hidden:false,type:"text"},
					{name:"height",caption:"排放口高度",width:60/5,hidden:false,type:"text"},
					{name:"isSurveyCover",caption:"锅炉调查是否覆盖",width:60/5,hidden:false,type:"text",valueSet:"是否"},
...
<body>
	<div class="block">
		<h1 class="title">
			<i class="iconfont icon-guoluxinxi1"></i>
			单独锅炉（非工业）信息
