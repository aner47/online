	...
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				columns :[
					...
					{name:"machineryType",caption:"机械类型",hidden:false,type:"text"},
					{name:"machineryInventory",caption:"机械保有量（台/辆）",hidden:false,type:"text"},
					{name:"totalPower",caption:"总功率（千瓦）",hidden:false,type:"text"},
					{name:"fuelConsume",caption:"燃料消耗量（吨）",hidden:false,type:"text"},
					{name:"fuelSulfurRate",caption:"燃料含硫率（％）",hidden:false,type:"text"},
					{name:"annualWorkHours",caption:"年工作时间（小时）",hidden:false,type:"text"},
