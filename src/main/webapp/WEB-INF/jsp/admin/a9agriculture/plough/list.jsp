	...
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				columns :[
					...
					{name:"soilPh",caption:"土壤酸碱度",hidden:false,type:"text"},
					{name:"agriculturalAcreage",caption:"耕地面积（亩）",hidden:false,type:"text"},
					{name:"soyaAcreage",caption:"大豆种植面积（亩）",hidden:false,type:"text"},
					{name:"peanutAcreage",caption:"花生种植面积（亩）",hidden:false,type:"text"},
					{name:"greenManureAcreage",caption:"绿肥种植面积（亩）",hidden:false,type:"text"},
