...
<script type="text/javascript">
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"type",caption:"类型",hidden:false,type:"text"},
					{name:"actualType",caption:"具体类型",hidden:false,type:"text"},
					{name:"useQuantity",caption:"使用量（吨）",hidden:false,type:"text"},
					{name:"nitrogenPurification",caption:"氮折纯量（吨）",hidden:false,type:"text"},
					{name:"useMonth",caption:"施用月份",hidden:false,type:"text"},
