		...
		<div class="dialog_div">
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="power" number="true" onKeyUp="value=value.replace(/[^0-9.]/g,'')"> 
			...
			<div class="infPara ">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="annualConsume" number="true" onKeyUp="value=value.replace(/[^0-9.]/g,'')"/> 
					</div>
				</div>
			</div>
			<div class="infPara ">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="fuelSulphurRate" number="true" onKeyUp="value=value.replace(/[^0-9.]/g,'')"/>
					</div>
				</div>
			</div>
