...
<script type="text/javascript">
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"boatType",caption:"船型",hidden:false,type:"text"},
					{name:"power",caption:"功率（千瓦）",hidden:false,type:"text"},
					{name:"number",caption:"数量（艘）",hidden:false,type:"text"},
					{name:"fuelType",caption:"燃油类型",hidden:false,type:"text"},
					{name:"annualConsume",caption:"消耗量（吨/年/艘）",hidden:false,type:"text"},
					{name:"fuelSulphurRate",caption:"燃料含硫率（％）",hidden:false,type:"text"},
