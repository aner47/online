	...
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				columns :[
					...
					{name:"cropType",caption:"农作物类型",hidden:false,type:"text"},
					{name:"yield",caption:"产量（吨）",hidden:false,type:"text"},
					{name:"strawManure",caption:"秸秆肥料利用比例（%）",hidden:false,type:"text"},
					{name:"strawFodder",caption:"秸秆饲料利用比例（%）",hidden:false,type:"text"},
					{name:"strawFuel",caption:"秸秆燃料利用比例（%）",hidden:false,type:"text"},
					{name:"industrialRaw",caption:"工业原料利用比例（%）",hidden:false,type:"text"},
					{name:"edibleRaw",caption:"食用菌基料利用比例（%）",hidden:false,type:"text"},
					{name:"openBurning",caption:"露天焚烧利用比例（%）",hidden:false,type:"text"},
					{name:"other",caption:"其他利用比例（%）",hidden:false,type:"text"},
