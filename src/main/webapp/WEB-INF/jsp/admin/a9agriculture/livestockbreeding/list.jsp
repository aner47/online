	...
	require(["grid","hide","upload","select","panel"],function(g,hide,upload){
		var opts = {
				...
				columns :[
					...
					{name:"town",caption:"乡镇",hidden:false,type:"text"},
					{name:"enterprise.name",caption:"养殖场名称",hidden:false,type:"text"},
					{name:"livestockType",caption:"畜禽类型",hidden:false,type:"text"},
					{name:"breedingMethod",caption:"养殖方式",hidden:false,type:"text"},
					{name:"avgBreedingPeriod",caption:"平均饲养周期（天）",hidden:false,type:"text"},
					{name:"breedNum",caption:"总饲养量（万只）",hidden:false,type:"text"},
					{name:"outputTotal",caption:"总出栏数（万只）",hidden:false,type:"text"},
					{name:"reserveNum",caption:"年末存栏量（万只）",hidden:false,type:"text"},
					...
					{name:"operate",caption:"操作",width:120,isHtml:true,html:'<a id="view" style="cursor: pointer;color:#888888;"><i id="tianbao" class="iconfont icon-bianji" style="color:#6495ED;">上传图片</i></a>',	
						events :[{
								...
								handle:function(){
									...
									location.href="../photofile/departmentlist.jhtml?enterpriseId="+id+"&departmentType=NYWXuQinYangZhi";
		...
		$("#download").click(function(){
			location.href="../livestockbreeding/downloanExcel.jhtml"
		});
