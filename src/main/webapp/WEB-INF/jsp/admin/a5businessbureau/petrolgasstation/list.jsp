...
<script type="text/javascript">
	require(["grid","hide","upload","select","panel"],function(g,hide,upload){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"enterprise.name",caption:"加油站名称",hidden:false,type:"text"},
					{name:"city",caption:"行政区",hidden:false,type:"text"},
					{name:"houseNumber",caption:"详细地址",hidden:false,type:"text"},
					{name:"longitude",caption:"经度",hidden:false,type:"text"},
					{name:"latitude",caption:"纬度",hidden:false,type:"text"},
					{name:"oilType",caption:"油品类型",hidden:false,type:"text"},
					{name:"annualSell",caption:"年销售量（吨）",hidden:false,type:"text"},
					{name:"oilStandard",caption:"油品标准",hidden:false,type:"text"},
					{name:"undergroundStorage",caption:"地下储罐容量（立方米）",hidden:false,type:"text"},
					{name:"supplyFrequency",caption:"补给频率（次/月）",hidden:false,type:"text"},
					{name:"isOilRecycle",caption:"是否安装油气回收装置",hidden:false,type:"text"},
					{name:"oilRecycleRate",caption:"油气回收率（%）",hidden:false,type:"text"},
					...
					{name:"operate",caption:"操作",width:120,isHtml:true,html:'<a id="view" style="cursor: pointer;color:#888888;"><i id="tianbao" class="iconfont icon-bianji" style="color:#6495ED;">上传图片</i></a>',	
						events :[{
								...
								handle:function(){
									...
									location.href="../photofile/departmentlist.jhtml?enterpriseId="+id+"&departmentType=SWJJiaYouZhan";
		...
		$("#download").click(function(){
			location.href="../petrolgasstation/downloanExcel.jhtml"
		});
