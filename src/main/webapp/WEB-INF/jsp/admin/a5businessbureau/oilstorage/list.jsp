...
<script type="text/javascript">
	require(["grid","hide","upload","select","panel"],function(g,hide,upload){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"enterprise.name",caption:"储油库名称",hidden:false,type:"text"},
					...
					{name:"annualTotal",caption:"年总储量（吨）",hidden:false,type:"text"},
					{name:"storageType",caption:"储罐类型",hidden:false,type:"text"},
					{name:"storageCycle",caption:"储存周期（天）",hidden:false,type:"text"},
					{name:"isOilRecycle",caption:"装卸车过程是否已安装油气回收",hidden:false,type:"text"},
					...
					{name:"operate",caption:"操作",width:120,isHtml:true,html:'<a id="view" style="cursor: pointer;color:#888888;"><i id="tianbao" class="iconfont icon-bianji" style="color:#6495ED;">上传图片</i></a>',	
						events :[{
								...
								handle:function(){
									...
									location.href="../photofile/departmentlist.jhtml?enterpriseId="+id+"&departmentType=SWJChuYouKu";
		...
		$("#download").click(function(){
			location.href="../oilstorage/downloanExcel.jhtml"
		});
