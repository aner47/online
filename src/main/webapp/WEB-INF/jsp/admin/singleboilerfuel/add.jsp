...
<script type="text/javascript">
	require(
			...
			function(hide) {
				...
				//燃料类型
				//var fuelType =  $("#fuelType", "#boiler_form").select({name:"fuelType",zIndex:7});
						...
						.validate(
								{
									...
									submitHandler : function(form) {
										...
										var options = {
											url : base
													+ '/web/singleboilerfuel/save.jhtml',
											type : 'post',
											dataType : 'json',
		...
		<div class="dialog_div">
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
					<input type="" class="input" name="fuelType" placeholder="燃料类型" number=true required readonly="readonly">
						<!-- <div id="fuelType" data-code="单独锅炉【锅炉编号】" class="selF"></div> -->
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="annualConsumption" placeholder="年消耗量" number=true required>
					</div>
				</div>
			</div>
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="unit" placeholder="单位" required>
					</div>
				</div>
			</div>
