	...
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				columns :[
					...
					{name:"berths",caption:"泊位数",hidden:false,type:"text"},
					...
					{name:"containerCapacity",caption:"集装箱吞吐量（万标准箱）",hidden:false,type:"text"},
					{name:"arriveLeaveTotal",caption:"船舶抵离港总次数",hidden:false,type:"text"},
