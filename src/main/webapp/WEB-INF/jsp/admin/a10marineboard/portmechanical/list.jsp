...
<script type="text/javascript">
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"enterprise.name",caption:"港口名称",hidden:false,type:"text"},
					{name:"mechanicalType",caption:"机械类型",hidden:false,type:"text"},
					{name:"mechanicalInventory",caption:"机械保有量（台）",hidden:false,type:"text"},
					{name:"totalPower",caption:"总功率（千瓦）",hidden:false,type:"text"},
					{name:"fuelConsumption",caption:"燃料消耗量（吨）",hidden:false,type:"text"},
					{name:"fuelSulfurRate",caption:"燃料含硫率（%）",hidden:false,type:"text"},
