...
<script type="text/javascript">
	require(
			...
			function(hide) {
				...
				$("#mechanicalType", "#boiler_form").select({name:"mechanicalType",isCustom: true,zIndex:9});
		...
		<div class="dialog_div">
			...
			<div class="infPara ">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<!-- <input type="" class="input" name="enterpriseId" required> -->
			...
			<div class="infPara ">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="mechanicalInventory" number="true" required onKeyUp="value=value.replace(/[\D]/g,'')"/>
					</div>
				</div>
			</div>
			<div class="infPara ">
			...
			<div class="infPara ">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="fuelConsumption" number="true" required onKeyUp="value=value.replace(/[^0-9.]/g,'')"/>
					</div>
				</div>
			</div>
			<div class="infPara ">
