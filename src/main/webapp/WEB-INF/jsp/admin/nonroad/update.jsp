		...
		<div class="dialog_div">
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<div id="dischargeStandard" data-defaultValue="${nonRoad.dischargeStandard}" data-code="机动车调查【排放标准】" class="selF"></div>
					</div>
				</div>
			</div>
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="num" value="${nonRoad.num}" placeholder="数量" number=true required>
					</div>
				</div>
			</div>
			...
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="avgPower" value="${nonRoad.avgPower}" placeholder="平均功率（kw）" number=true required>
					</div>
				</div>
			</div>
			<div class="infPara">
				<div class="infParaCon">
					...
					<div class="infpCon">
						<input type="" class="input" name="singleOilConsumption" value="${nonRoad.singleOilConsumption}" placeholder="单车油耗量（L/h）" number=true required>
					</div>
				</div>
			</div>
