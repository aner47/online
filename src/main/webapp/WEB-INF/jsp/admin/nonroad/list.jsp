...
<script type="text/javascript">
	require(["grid","hide","select","panel"],function(g,hide){
		var opts = {
				...
				url:"query.jhtml",
				columns :[
					{name:"nonroadMechanical",caption:"非道路机械",width:60/5,hidden:false,type:"text",prefix:"P"},
					{name:"dischargeStandard",caption:"排放标准",width:60/5,hidden:false,type:"text"},
					{name:"num",caption:"数量",width:60/5,hidden:false,type:"text"},
					{name:"avgPower",caption:"平均功率（kw）",width:60/5,hidden:false,type:"text"},
					{name:"singleOilConsumption",caption:"单车油耗量（L/h）",width:60/5,hidden:false,type:"text"},
